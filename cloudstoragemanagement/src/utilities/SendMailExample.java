...
public class SendMailExample {
	 ...
	 * @param args
	 */
	public String main(String sendermail,String subject,String code)throws MessagingException {
		// TODO Auto-generated method stub
		// Recipient's email ID needs to be mentioned.
            String reply="FAILED";
            
			String sender_email = "ENTER_MAIL_ID_FROM_WHICH_OTP_SHOULD_BE_GENERATED";       //ENTER_MAIL_ID_FROM_WHICH_OTP_SHOULD_BE_GENERATED
		//	String sender_password = "your password";
			String sender_host = "smtp.gmail.com";
			String sender_port = "465";
			String reciever_id = sendermail;
			String subject_to_be_given = subject;
...
{
	String sender_email = "ENTER_MAIL",                                                                               //ENTER_MAIL_ID_FROM_WHICH_OTP_SHOULD_BE_GENERATED
			sender_password = "ENTER UNIQUE APP PSD OF MAIL GEN IT FROM MANAGE_YOUR_GOOGLE_ACCOUNT";            //ENTER UNIQUE PASSWORD
